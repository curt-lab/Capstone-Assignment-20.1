...
I also did some initial exploration of how a classification model would perform on the same dataset.  Just to get started I tried a decision tree and a logistic regression model just using very basic or default pararmeters.  The results weren't great, with only ~55% and ~57% accuracy.  Which is better than a wild guess (1 out of 9, or 11%), but I will do deeper exploration of this by GridSearch over a range of hyperparameters to improve it. 
